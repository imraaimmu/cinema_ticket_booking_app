...
public class TicketConstants {
	...
	public static final String CANNOT_BOOK_TICKET_FOR_INFANT_AND_CHILD_WITHOUT_ADULT = ERROR_MESSAGE_PREFIX + "Infants and Children should be accompanied by Adults";
	...
	public static final String INVALID_TICKET_COUNT = "Error: Invalid ticket count for %s";
